...
<p align="center">  <a href="https://fileuni.com"><img src="https://img.shields.io/badge/웹사이트-fileuni.com-blue?style=for-the-badge" alt="웹사이트"></a>  <a href="https://docs.fileuni.com/nextcloud-compatibility"><img src="https://img.shields.io/badge/문서-docs.fileuni.com-green?style=for-the-badge" alt="문서"></a>  <a href="https://github.com/FileUni/FileUni-Project"><img src="https://img.shields.io/badge/GitHub-FileUni-black?style=for-the-badge&logo=github" alt="GitHub"></a>  <a href="https://hub.docker.com/r/fileuni/fileuni"><img src="https://img.shields.io/badge/Docker-fileuni-blue?style=for-the-badge&logo=docker" alt="Docker Hub"></a> </p> 
> 안내: 이 프로젝트는 아직 초기 단계에 있습니다. 불안정할 수 있으며 현재는 테스트 및 교육용으로만 사용하도록 의도되었습니다.

FileUni는 성능, 보안, 모듈형 배포를 위해 Rust로 구축된 차세대 스토리지 및 파일 관리 플랫폼입니다.

초경량 장치부터 완전한 서버까지, FileUni는 전용 하드웨어 없이 NAS급 기능을 제공하며 CLI, GUI, 웹 구성 요소 전반에 걸쳐 하나의 확장 가능한 코드베이스를 유지합니다.

또 다른 중요한 특징은 Nextcloud 클라이언트와의 호환성입니다. 파일 관리, 즐겨찾기, 공유, 미디어 관련 흐름, WebDAV 접근은 Nextcloud 클라이언트 생태계와의 호환성을 목표로 하며, Chat과 Notes는 후속 로드맵에 남아 있습니다.

## 이 저장소의 역할

이 저장소는 FileUni의 공개 프로젝트 허브입니다. 주된 용도는 다음과 같습니다.
...
주 개발 워크스페이스는 비공개 모노레포에 있으며, 일부 구성 요소가 릴리스와 공개 협업을 위해 이곳으로 동기화됩니다.

## 왜 FileUni인가

- Rust 기반의 고성능 아키텍처
- 다양한 배포 규모를 위한 모듈형 설계
- 전용 하드웨어 없이 NAS 기능 제공
- WebDAV, 파일 관리, 즐겨찾기, 공유, 미디어 흐름에서의 Nextcloud 클라이언트 호환성
- FTP, SFTP, WebDAV, S3를 포함한 멀티 프로토콜 접근
- 스토리지 환경에 맞춘 신뢰성과 보안 중심 설계

## 관련 저장소

- [OfficialSiteDocs](https://github.com/FileUni/OfficialSiteDocs) - 문서
- [frontends](https://github.com/FileUni/frontends) - 프론트엔드 컴포넌트
- [yh-filemanager-vfs-storage-hub](https://github.com/FileUni/yh-filemanager-vfs-storage-hub) - VFS 코어
...
이 저장소에는 FileUni의 공개 프로젝트 레이어가 포함됩니다. 추가 모듈은 시간이 지나며 점진적으로 공개될 수 있습니다.
